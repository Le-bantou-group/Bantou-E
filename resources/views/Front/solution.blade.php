...
<head>
    ...
    <title>BANTOU-ENERGY || solutions</title>
...
<body>
    ...
    <main>
        <section class="header-views">
            <h1 class="title-view">Déploiement de solutions propriétaires</h1>
        ...
        <section class="contain">
            ...
            <aside class="text-aside">
                ...
                <p>Lorsque vient le temps de mettre en œuvre, nous le faisons avec la conviction que chaque solution
                    déployée doit être à la fois novatrice et durable. Bantou Énergie se distingue par ses solutions
                    propriétaires, issues de nos propres recherches et de notre vaste expérience dans le domaine. Ces
                    solutions, à l’avant-garde de la technologie et des meilleures pratiques du marché, sont développées
                    pour répondre aux besoins concrets et aux défis énergétiques spécifiques que rencontrent nos
                    clients.Nous veillons à ce que chaque solution mise en place ne soit pas simplement une réponse
                    temporaire, mais un véritable pilier sur lequel nos clients pourront s’appuyer durablement. Notre
                    engagement va bien au-delà de l'installation : nous assurons le suivi, la maintenance et
                    l'amélioration continue de ces solutions, pour garantir leur pérennité et leur efficacité à long
                    terme.</p>
                <!--<button>Enregister</button>-->
            </aside>
            <aside class="img-aside">
                <div><img src="{{ asset('Front/images/Carousel/solution.jpg') }}" alt=""></div>
            </aside>
        </section>
        <!--Carousel-->
    ...
    <script>
        ...
        var carousel = new bootstrap.Carousel(myCarousel, {
            interval: 3000, // Temps en millisecondes (3 secondes)
            wrap: true // Le carousel recommencera au premier slide après le dernier
        });
    </script>
