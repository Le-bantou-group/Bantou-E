...
<body>
    ...
    <main>
        <section class="header-views">
            <h1 class="title-view" style="font-size:3vw;">Conseils et Audits</h1>
            <div class="description">
                <a href="{{ route('home') }}" target="_blank" rel="noopener noreferrer">Accueil/</a>
                <a href="{{ route('services') }}" target="_blank" rel="noopener noreferrer">Prestations des
                    services/</a>
                <a href="{{ route('audits') }}" target="_blank" rel="noopener noreferrer">Conseils et Audits/</a>
            </div>
        </section>
        <section class="contain">
            ...
            <aside class='text-aside'>
                ...
                <p style='margin-top:10px;margin-bottom:10px;'>Dans la quête de l’excellence, il est d’une importance
                    capitale de commencer par l’examen minutieux de l’existant. Nos experts, véritables artisans du
                    savoir, s’emploient à réaliser des audits d’une grande profondeur, où chaque filament d’énergie
                    consommée est mesuré, chaque processus observé et chaque défaillance potentielle repérée. L’audit
                    que nous proposons n’est point une simple formalité, mais une introspection rigoureuse de
                    l’efficacité énergétique présente chez nos clients.

                    Sur la base de ces observations fines, nous prodiguons des conseils stratégiques, issus d’une
                    réflexion éclairée, afin d’optimiser l’usage des ressources et d’accroître de manière significative
                    la performance énergétique. Ces préceptes, alliant pragmatisme et vision d’avenir, permettent à nos
                    clients de naviguer avec assurance dans un environnement énergétique toujours plus complexe.</p>
                <!--<button-- class='btn-abs' style='color:#000;
        background:transparent;
        border:0;
        opacity:.8;'>Enregister</button-->
            </aside>
            <aside class="img-aside">
                <div><img src="{{ asset('Front/images/Carousel/audit2.jpg') }}" alt=""></div>
            </aside>
        </section>
        <!--Carousel-->
