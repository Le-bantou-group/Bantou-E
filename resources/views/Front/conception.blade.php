...
<body>
    ...
    <main>
        <section class="header-views">
            <h1 class="title-view">Conception</h1>
            <div class="description">
                ...
                <a href="#" target="_blank" rel="noopener noreferrer">Conception</a>
            </div>
        </section>
        <section class="contain">
            ...
            <aside class="text-aside">
                ...
                <p> De la conception naît l’essence même du projet. C’est là, dans l’atelier de nos esprits ingénieux,
                    que s’élaborent les systèmes énergétiques qui éclaireront demain. Notre équipe de spécialistes,
                    animée par le souci du détail et l’amour de l’innovation, conçoit des systèmes alliant les
                    technologies les plus récentes et les pratiques les plus durables.

                    Chaque conception est pensée dans une harmonie parfaite entre efficacité et respect de
                    l’environnement. Rien n’est laissé au hasard, car nous avons à cœur de minimiser l’impact
                    environnemental tout en maximisant la performance énergétique. Le mariage de ces deux impératifs est
                    au centre de notre démarche, et chaque solution que nous proposons porte l’empreinte de cette
                    dualité maîtrisée.</p>
                <!--<button>Enregister</button>-->
            </aside>
            <aside class="img-aside">
                <div><img src="{{ asset('Front/images/Carousel/conception (1).jpg') }}" alt=""></div>
            </aside>
        </section>
        <!--Carousel-->
