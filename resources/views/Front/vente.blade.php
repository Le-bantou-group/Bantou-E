...
<body>
    ...
    <main>
        <section class="header-views">
            <h1 class="title-view">Vente de KEA (KIT ELECTRIQUE AUTONOME)</h1>
            <div class="description">
                ...
                <a href="#" target="_blank" rel="noopener noreferrer">Vente de KEA (KIT ELECTRIQUE AUTONOME)/</a>
            </div>
        </section>
        <section class="contain">
            ...
            <aside class="text-aside">
                ...
                <p>Nos kits sont adaptés aux besoins spécifiques des ménages, entreprises et collectivités, et incluent
                    tout le nécessaire pour une installation simple et rapide. Chaque kit est composé de technologies de
                    pointe qui exploitent les énergies renouvelables, telles que l’énergie solaire, pour garantir un
                    approvisionnement énergétique continu et respectueux de l’environnement.

                    Ce que nos kits offrent :
                    - Autonomie énergétique : Nos kits permettent de réduire la dépendance aux réseaux électriques
                    traditionnels en offrant une solution autonome et renouvelable.

                    - Simplicité d’installation : Conçus pour être facilement installés, nos kits sont accompagnés de
                    guides d’utilisation clairs et d’un service après-vente dédié pour garantir une mise en œuvre sans
                    souci.

                    - Solutions sur mesure : Nos kits sont disponibles en plusieurs configurations pour s’adapter aux
                    besoins spécifiques de nos clients, qu'il s'agisse d'un usage domestique, agricole ou industriel.

                    - Économies à long terme : En investissant dans nos kits d’électrification, nos clients réalisent
                    des économies substantielles sur leurs factures d’énergie tout en contribuant à la protection de
                    l’environnement.</p>
                <!--<button>Enregister</button>-->
            </aside>
            <aside class="img-aside">
                <div><img
                        src="{{ asset('Front/images/Image develppeur/Image develppeur/solar-panels-futuristic-lunar-base-harnessing-renewable-energy.jpg') }}"
                        alt=""></div>
            </aside>
        </section>
        <!--Carousel-->
                    ...
                    <div class="carrousel-contain">
                        ...
                        <div class='item'>
                            <div class='text-contain'>
                                ...
                                <button onclick="window.location.href='{{ route('audits') }}'"><i
