                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <aside style='width:100%;display:flex;justify-content:center;align-item:center;'>
                                ...
                                <div class="col-md-6">
                                <div class="card">
                                    <div class="card-header"><h3>Modification de Produit</h3></div>
                                    <div class="card-body">
                                        <form class="forms-sample" method='POST' action='{{ route('update_product') }}' enctype="multipart/form-data">
                                            @csrf
                                            <input type='text' style='display:none;' name="id" value="{{$produit->id }}">
                                            <div class="form-group">
                                                <label for="exampleInputName1">Nom du produit</label>
                                                <input type="text" class="form-control" name='nom' id="exampleInputName1" value="{{ $produit->nom }}" placeholder="Nom">
                                            </div>
                                            <div class="form-group">
                                                <label for="examplestock">Quantité en stock</label>
                                                <input type="text" class="form-control" name='stock' id="examplestock" value="{{  $produit->stock }} " placeholder="Quantité">
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="price">Prix</label>
                                                        <input type="text" name='prix' class="form-control" value='{{ $produit->prix }}'  id="price" placeholder="20.000CFA">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name='code' value='{{ $produit->code }}' id="code" placeholder="TS0-04">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" value="{{ $produit->description }}" name='description' id="exampleTextarea1" rows="4"></textarea>
                                            </div>
